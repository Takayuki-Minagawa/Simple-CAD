...
export const ja: Translations = {
  ...
  transformTitle: '変形',
  transformSelected: '{count} 件選択中',
  transformCurrentBounds: '選択範囲: W {width} mm / H {height} mm',
  transformMove: '移動',
  transformCopy: '複写',
  transformScale: '縮尺',
  transformStretch: 'パラメトリック',
  transformDx: 'X移動量',
  transformDy: 'Y移動量',
  transformCopyCount: '複写数',
  transformOriginX: '基点 X',
  transformOriginY: '基点 Y',
  transformScaleX: 'X倍率',
  transformScaleY: 'Y倍率',
  transformTargetWidth: '目標幅',
  transformTargetHeight: '目標高さ',
  transformAnchorX: 'X固定位置',
  transformAnchorY: 'Y固定位置',
  transformAnchorMinX: '左',
  transformAnchorCenterX: '中央',
  transformAnchorMaxX: '右',
  transformAnchorMinY: '下',
  transformAnchorCenterY: '中央',
  transformAnchorMaxY: '上',
  transformApply: '適用',
  transformInvalidNumber: '数値入力が不正です。',
  ...
  transformInvalidSelection:
    '選択内容には変形可能な図形がありません。閉じて対象を選び直してください。',
