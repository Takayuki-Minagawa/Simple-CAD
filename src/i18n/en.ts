...
export const en: Translations = {
  ...
  transformSelected: '{count} selected',
  transformCurrentBounds: 'Selection bounds: W {width} mm / H {height} mm',
  transformMove: 'Move',
  transformCopy: 'Copy',
  transformScale: 'Scale',
  transformStretch: 'Parametric',
  transformDx: 'Delta X',
  transformDy: 'Delta Y',
  transformCopyCount: 'Copies',
  transformOriginX: 'Origin X',
  transformOriginY: 'Origin Y',
  transformScaleX: 'Scale X',
  transformScaleY: 'Scale Y',
  transformTargetWidth: 'Target Width',
  transformTargetHeight: 'Target Height',
  transformAnchorX: 'Anchor X',
  transformAnchorY: 'Anchor Y',
  transformAnchorMinX: 'Left',
  transformAnchorCenterX: 'Center',
  transformAnchorMaxX: 'Right',
  transformAnchorMinY: 'Bottom',
  transformAnchorCenterY: 'Middle',
  transformAnchorMaxY: 'Top',
  transformApply: 'Apply',
  transformInvalidNumber: 'Invalid numeric input.',
  ...
  snapModeGrid: 'Grid',
  snapModeEndpoint: 'End',
  snapModeMidpoint: 'Mid',
  snapModeIntersection: 'Int',
  snapModePerpendicular: 'Perp',
  snapModeNearest: 'Near',
  ...
  snapModeTooltip: 'Toggle snap mode',
  ...
  guideSlabNext: 'Click the next vertex, double-click or press Enter to finish',
  ...
  guideSplineNext: 'Click the next point, double-click or press Enter to finish',
